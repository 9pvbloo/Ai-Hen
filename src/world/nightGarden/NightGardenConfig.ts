...
/** The path blockout is reviewed in its garden context; the Pavilion itself remains unchanged. */
export const PAVILION_ISOLATION_MODE = false
...
export const NIGHT_GARDEN = {
  ...
  layouts: {
    ...
    tablet: {
      ...
      pondScale: [0.88, 0.9], mistLayers: 2, pathCount: 10, bambooCount: 22, rockCount: 6,
    },
    portrait: {
