...
export const NIGHT_GARDEN = {
  ...
  layouts: {
    desktop: {
      ...
      pondScale: [1, 1], mistLayers: 3, pathCount: 15, bambooCount: 30, rockCount: 7,
    },
    tablet: {
      crossingDistance: 29, cameraX: -0.42, cameraY: -1.0,
      targetX: -0.18, targetY: -3.05, targetZ: -24,
      pondScale: [0.88, 0.9], mistLayers: 2, pathCount: 12, bambooCount: 22, rockCount: 6,
    },
    portrait: {
      crossingDistance: 25, cameraX: -0.18, cameraY: -0.78,
      targetX: -0.05, targetY: -3.12, targetZ: -22,
      pondScale: [0.68, 0.78], mistLayers: 1, pathCount: 9, bambooCount: 15, rockCount: 4,
    },
