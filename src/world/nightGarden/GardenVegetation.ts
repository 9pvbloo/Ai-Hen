...
export class GardenVegetation {
  ...
  private readonly shrubMaterial = new MeshStandardMaterial({ color: '#274634', vertexColors: true, roughness: 0.98, metalness: 0 })
  private readonly treeWoodMaterial = new MeshStandardMaterial({ color: '#27352c', vertexColors: true, roughness: 0.96, metalness: 0 })
  private readonly treeFoliageMaterial = new MeshStandardMaterial({ color: '#203b2a', vertexColors: true, roughness: 0.97, metalness: 0 })
  private readonly bambooMaterial = new MeshStandardMaterial({ color: '#315440', vertexColors: true, roughness: 0.95, metalness: 0 })
