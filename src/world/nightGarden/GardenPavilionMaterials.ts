...
export class GardenPavilionMaterials {
  ...
  readonly timber = this.createWoodMaterial('#2c211a', 0.86)
  readonly trim = this.createWoodMaterial('#3a2b21', 0.8)
  readonly soffit = this.createWoodMaterial('#161411', 0.92)
