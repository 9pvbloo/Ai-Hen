...
export const MOON_GATE = {
  ...
  ranges: {
    phase: { start: 0.58, end: 1 },
    emergence: { start: 0.58, end: 0.74 },
    recognition: { start: 0.74, end: 0.82 },
    approach: { start: 0.82, end: 0.92 },
    threshold: { start: 0.92, end: 1 },
  } satisfies Record<string, ScrollRange>,
  reducedMotionApproachScale: 0.12,
  layouts: {
